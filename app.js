    ...
    const FISHING_PORTS = [
        { name: '오천항', lat: 36.38, lon: 126.47, region: '충남', station: 'DT_0025', stationName: '보령', current: '16LTC03', currentName: '천수만', wxLat: 36.4393, wxLon: 126.5196, badatimeId: '355' },
        { name: '삼길포항', lat: 37.00, lon: 126.45, region: '충남', station: 'DT_0017', stationName: '대산', current: '07DS02', currentName: '대산항', wxLat: 37.0035, wxLon: 126.4528, badatimeId: '144' },
        ...
        { name: '홍원항', lat: 36.30, lon: 126.48, region: '충남', station: 'DT_0051', stationName: '서천마량', current: '12JB11', currentName: '비인만', wxLat: 36.1563, wxLon: 126.5017, badatimeId: '523' },
        ...
        { name: '영목항', lat: 36.38, lon: 126.32, region: '충남', station: 'DT_0025', stationName: '보령', current: '16LTC03', currentName: '천수만', wxLat: 36.3997, wxLon: 126.4276, badatimeId: '354' },
        ...
        { name: '남당항', lat: 36.53, lon: 126.44, region: '충남', station: 'DT_0025', stationName: '보령', current: '16LTC03', currentName: '천수만', wxLat: 36.5369, wxLon: 126.4689, badatimeId: '356' },
        { name: '대야도', lat: 36.38, lon: 126.50, region: '충남', station: 'DT_0025', stationName: '보령', current: '16LTC03', currentName: '천수만', wxLat: 36.4673, wxLon: 126.4160, badatimeId: '462' },
        ...
        { name: '비응항', lat: 35.97, lon: 126.62, region: '전북', station: 'DT_0018', stationName: '군산', current: '12JB14', currentName: '군산항입구', badatimeId: '118' },
        { name: '선유도', lat: 35.82, lon: 126.42, region: '전북', station: 'DT_0018', stationName: '군산', current: '06GS07', currentName: '고군산군도' },
        { name: '녹동항', lat: 34.48, lon: 127.08, region: '전남', station: 'DT_0026', stationName: '고흥발포', current: '06YS09', currentName: '거금수도', wxLat: 34.5231, wxLon: 127.1436, badatimeId: '219' },
        { name: '마량항', lat: 34.38, lon: 126.38, region: '전남', station: 'DT_0031', stationName: '진도', current: '22LTC12', currentName: '마량항', badatimeId: '62' },
        { name: '하효항', lat: 33.23, lon: 126.58, region: '제주', station: 'DT_0010', stationName: '서귀포', current: '08JJ07', currentName: '서귀포', badatimeId: '482' },
        { name: '김녕항', lat: 33.55, lon: 126.77, region: '제주', station: 'DT_0022', stationName: '성산포', current: '08JJ03', currentName: '성산포' },
        { name: '한림항', lat: 33.42, lon: 126.27, region: '제주', station: 'DT_0023', stationName: '모슬포', current: '08JJ13', currentName: '애월항북측', badatimeId: '77' },
        { name: '대포항', lat: 35.16, lon: 129.18, region: '경남', station: 'DT_0005', stationName: '부산', current: '18LTC13', currentName: '해운대', badatimeId: '241' },
        { name: '구룡포항', lat: 35.98, lon: 129.57, region: '경북', station: 'DT_0091', stationName: '포항', current: '17LTC05', currentName: '울도', badatimeId: '209' },
        ...
        { name: '백사장항', lat: 36.59, lon: 126.31, region: '충남', station: 'DT_0067', stationName: '안흥', current: '23GA01', currentName: '안면도서측', wxLat: 36.5864, wxLon: 126.3181, badatimeId: '175' },
     ...
     */
    async function fetchBadatimeFlowPct(stationCode, dateStr, overrideSid) {
        const sid = overrideSid || BADATIME_STATION_MAP[stationCode];
        if (!sid) return null;
    ...
    // 조차 기반 유속 퍼센트 계산 — MinMax 정규화: (diff-min)/(max-min) × 100
    // 동적 윈도우(±15일) 우선, 고정 테이블 fallback
    ...
    async function fetchTideHighLow(prefetchedItems) {
        ...
        try {
            ...
            // 백그라운드 ①: 바다타임 실데이터 조회 (최우선, 포트별 고유 ID 우선)
            (async () => {
                try {
                    const portBtId = _selectedPort ? _selectedPort.badatimeId : null;
                    const btPct = await fetchBadatimeFlowPct(stationCode, dateStr, portBtId);
    ...
    function renderCombinedChart() {
        ...
        if (hasTide) {
            scales.yTide = {
                ...
                ticks: { stepSize: 100, color: '#38bdf8', font: { size: 10 }, callback: v => v + '', padding: 0, crossAlign: 'far' },
                grid: { color: 'rgba(56,189,248,0.07)' },
                border: { display: false },
                title: { display: false },
                afterFit(axis) { axis.width = 18; },
            };
        }
        if (hasSpeed) {
            ...
            scales.ySpeed = {
                ...
                min: 0,
                max: speedAxisMax,
                ticks: { stepSize: speedStep, color: '#34d399', font: { size: 10 }, callback: v => currentSpeedUnit === 'kn' ? v.toFixed(1) : v + '', padding: 0, crossAlign: 'far' },
