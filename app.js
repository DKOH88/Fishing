    ...
    function renderCombinedChart() {
        ...
        if (hasTide) {
            scales.yTide = {
                ...
                ticks: { stepSize: 100, color: '#38bdf8', font: { size: 10 }, callback: v => v === 0 ? '[cm] 0' : v + '', padding: 0 },
        ...
        if (hasSpeed) {
            ...
            scales.ySpeed = {
                ...
                min: 0,
                max: speedAxisMax,
                ticks: { stepSize: speedStep, color: '#34d399', font: { size: 10 }, callback: v => v === 0 ? '0 [' + getCurrentSpeedUnitLabel() + ']' : (currentSpeedUnit === 'kn' ? v.toFixed(1) : v + ''), padding: 0 },
